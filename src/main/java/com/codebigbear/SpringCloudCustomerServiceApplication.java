...
@ComponentScan(basePackages = "com.codebigbear")
@EnableJpaRepositories("com.codebigbear.dao.jpa") // To segregate MongoDB and JPA repositories. Otherwise not needed.
@EnableSwagger2
@EnableDiscoveryClient
@EnableFeignClients
public class SpringCloudCustomerServiceApplication {

	static Class applicationClass = SpringCloudCustomerServiceApplication.class;
